...
import { GalleryHero } from '@/components/organisms/gallery-hero/gallery-hero';
import { PartnerCard } from '@/components/organisms/partner-card/partner-card';
import {
  Timeline,
  TimelineContent,
  TimelineDate,
...
const galleryHeroData = {
  videoDesktopSrc: linkStatic,
  videoMobileSrc: linkStatic,
  headline: 'Bali Real Estate',
  description:
    'Access the most exclusive luxury properties in Bali with curated listingsAccess the most exclusive luxury properties in Bali with curated listings.',
  mainImageSrc: '/images/luxury.png',
  mainImageAlt: 'Luxury property',
  infoTitle1: 'Premium Location',
  infoTitle2: 'Limited Offer',
  footerText: `Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur sapiente rerum mollitia...
  Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur sapiente rerum mollitia...
  Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur sapiente rerum mollitia...`,
  qrImageSrc: '/images/qr-code.svg',
  qrAlt: 'QR Code',
...
const partner = {
  images: ['/images/etienne.jpg', '/images/estate.jpg', '/images/etienne.jpg'],
  partnerName: 'Beach House on Lake Huron',
  partnerType: 'Real Estate',
  location: 'Bayfield, ON',
  rating: 2.66,
  reviewsCount: 128,
  description:
    'This sunny and spacious room is perfect for travelers seeking comfort and coziness near the lake...',
  ctaLabel: 'Check availability',
  onClickCTA: () => alert('Clicked!'),
  tags: ['Waterfront', 'Entire house', 'Family friendly'],
  logoUrl: '/images/etienne.jpg'
};
...
const SECTIONS = [
  {
    ...
    children: <GalleryHero {...galleryHeroData} />
  },
  {
    title: 'Dự án',
    bg: 'bg-gradient-to-br from-white via-indigo-50 to-indigo-100',
          ...
          <div className="col-span-2 text-sm font-normal relative">
            <div className="text-black flex flex-col gap-2 ">
              ...
              <div className="absolute bottom-[40%] -left-[140px]">
                <h3 className="-rotate-90 text-7xl font-bold outline-text">LOCATION</h3>
              </div>
      ...
      <div className="min-w-screen w-full">
        <div className="w-full grid grid-cols-3">
          <div className="text-black font-normal">
            ...
            <div className="pt-8 pb-4 pl-24 relative">
              <h2 className="text-2xl font-bold uppercase">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
              </h2>
              <p className="text-sm">
              ...
              <div className="absolute bottom-0 -right-[90px] z-10 opacity-90 bg-slate-200/40 rounded-md">
                <div className="p-2">
                  <Image
                    ...
                    width={256}
                    height={256}
                    className="w-44 h-44 object-contain rounded-md border"
                  />
                </div>
              </div>
            </div>
    ...
    children: (
      <div className="flex h-[100vh] w-screen">
        <div className="grid grid-cols-4 gap-2">
          <div className="relative max-h-screen group">
            <div className="h-full w-full overflow-hidden">
              <Image
                ...
                width={1920}
                height={1080}
                className="h-full w-auto object-cover border blur-[2px] group-hover:blur-0 transition-all duration-200"
              />
            </div>
            <div className="absolute top-0 left-0 w-full h-full p-4 opacity-0 group-hover:opacity-80 delay-100 transition-all duration-200">
              <div className="w-full h-full border border-white">
                <div className="h-full text-8xl font-bold flex justify-center items-center"></div>
              </div>
            </div>
          </div>
          <div>
            <div className="h-full grid grid-rows-2 grid-cols-1 gap-2">
          ...
          <div>
            <div className="h-full grid grid-rows-3 grid-cols-1 gap-2">
              <div className="relative group">
                <div className="h-full w-full overflow-hidden">
                  <Image
                    src="/images/estate.jpg"
...
export default LadingScrollPage;
