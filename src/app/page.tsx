...
import { BoxTransaction } from '@/components/molecules/box-transaction/box-transaction';
...
const HomePage = () => (
  <div>
    <Animation isVisible={true}>
      ...
      <div className="max-w-sreen w-full overflow-hidden text-black">
        <BoxTransaction data={[1, 2, 3]} />
      </div>
