  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        {/* Sliding Background */}
        <motion.div
          className={cn('absolute z-[1]', selectedItem?.color || activeColor)}
          initial={false}
          animate={{
          ...
          {items.map((item) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  'relative flex items-center justify-center gap-0.5 px-2 py-1.5  border-l-[1px] border-gray-400 outline-none',
